  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: Text("Thanks Giving",style: TextStyle(fontSize: ScreenUtil().setSp(22.w),fontFamily: "Raleway"),),
                    ...
                    children: [
                      ...
                      RaisedButton(
                        onPressed: () {
                          ...
                          Navigator.pushReplacementNamed(context, ThanksGivingScreen.id);
                        },
                        child: Text(
                          "Okay",
