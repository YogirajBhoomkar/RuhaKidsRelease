  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: Text("Frequently Asked Questions",style: TextStyle(fontSize: ScreenUtil().setSp(18.w),fontFamily: "Raleway"),),
      ...
      body: WebView(
        initialUrl:
            "https://kidsapp.ruha.co.in/faq.php?rand_no=${MainScreen.session}",
                    ...
                    children: [
                      ...
                      RaisedButton(
                        onPressed: () {
                          ...
                          Navigator.pushReplacementNamed(context, FAQScreen.id);
                        },
                        child: Text(
                          "Okay",
